...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelProdDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhostD86156e', static fn () => \EntityManagerGhostD86156e::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
